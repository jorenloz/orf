...
$msgError = "<div class='alert alert-danger fade in alertFixed' >
<i class='fa-fw fa fa-times'></i>
<strong>Error!</strong>Para poder crear un expediente debe primero clasificar el radicado.
</div>";


if($resTrd==-1) die($msgError);

//echo $resTrd->subSerieCodigo;
//echo $resTrd->serieCodigo;

$Rquery = "Select sgd_srd_codigo,sgd_sbrd_codigo, sgd_srd_id, sgd_sbrd_id from sgd_mrd_matrird where sgd_mrd_codigo in (select sgd_mrd_codigo from sgd_rdf_retdocf where radi_nume_radi = '$nurad' order by sgd_rdf_fech desc limit 1 )";
