...
function creaDirDepe( $ruta_raiz ,$anoCrear)
{
	...
	//  $anoCrear= "2008";
        ...
        if ( is_dir( $ruta_raiz.'/bodega/'.$anoCrear.'/'.$codigoDependenciaConPadding ) )
        {
            ...
            // Directorio para anexos de expedientes
            // Verifica si no existe un directorio docs
            if ( ! is_dir( $ruta_raiz.'/bodega/'.$anoCrear.'/'.$codigoDependenciaConPadding.'/exp' ) )
            {
                // Crea un directorio llamado docs
                if ( mkdir ( $ruta_raiz.'/bodega/'.$anoCrear.'/'.$codigoDependenciaConPadding.'/exp', 0777 ) )
                {
                    print "Directorio ".$ruta_raiz.'/bodega'.$anoCrear.'/'.$codigoDependenciaConPadding.'/exp'." creado.<br>";
                }else{
                    print "No se pudo crear el directorio ".$ruta_raiz.'/bodega/'.$anoCrear.'/'.$codigoDependenciaConPadding.'/exp.<br>';
                }
            }								
        }
