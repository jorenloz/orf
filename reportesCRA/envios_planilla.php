...
$titulos=array("DESTINATARIO","DIRECCION","CIUDAD_DEPTO","PESO","RADICADO");
			...
			$isql = "SELECT SALIDA,SGD_RENV_NOMBRE,ID_PAIS, SGD_RENV_VALOR,SGD_RENV_PESO,
					SGD_RENV_DIR, SGD_RENV_FECH, SGD_RENV_MPIO||'_'||SGD_RENV_DEPTO AS CIUDAD_DEPTO FROM (SELECT REG.radi_nume_sal AS SALIDA,REG.SGD_RENV_NOMBRE,REG.SGD_RENV_DIR,R.ID_PAIS, REG.SGD_RENV_VALOR,REG.SGD_RENV_PESO,
