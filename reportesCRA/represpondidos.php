...
$titulos=array("RADICADO","REMITENTE","UBICACION","ASUNTO","FECHA RADICACION","DEPENDENCIA","TIPO_DOC");
			...
			echo "<pre>".$isql = "SELECT distinct A.RADI_NUME_RADI AS ENTRADA, A.RA_ASUN AS ASUNTO, to_char(A.radi_fech_radi,'yyyy/mm/dd hh24:mi:ss') AS FECHAS,  B.DEPE_NOMB AS DEPENDENCIA, C.SGD_TPR_DESCRIP AS TIPO,
