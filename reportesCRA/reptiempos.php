...
$titulos=array("ENTRADA","INGRESO","REMITENTE","UBICACION","TIPO","TIEMPO","RESPUESTA","FECHA RADICADO","RESPONSABLE","FECHA DE ENVIO","DESTINATARIO","UBICACION","TIEMPO DE RTA");
			...
			$isql = "SELECT distinct X.RADI_NUME_SALIDA as SALIDA,  to_date(X.ANEX_RADI_FECH,'yyyy/mm/dd hh24:mi:ss') AS FECHARTA, 
					 ...
					 D.sgd_dir_nomremdes AS DESTINO, (C.MUNI_NOMB||' - '||T.DPTO_NOMB)as UBICACION2
					 FROM ANEXOS X
	...
	$campos_tabla = array("ENTRADA","FECHAS","SGD_DIR_NOMREMDES","UBICACION","TIPO","TIEMPO","SALIDA","FECHARTA","RESPO","FECHAENVIO", "DESTINO","UBICACION2","TRTA");
