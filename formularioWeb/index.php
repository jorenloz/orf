...
<ul>
	<h2>Buzón de quejas, peticiones y reclamos</h2>
<br> Los campos con (<font color="#FF0000">*</font>
	...
	<tr>
		...
		<div><select id="tipoSolicitud" name="tipoSolicitud" class="field select maximun" tabindex="1">
...
?>
	...
	&nbsp;
	<i>Coloca el nombre correcto al archivo ejemplo: cedula.pdf, cuenta_de_cobro.pdf, foto.jpg ....</i> 
	</li>
