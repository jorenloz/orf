...
$mail = new PHPMailer();
$db->conn->SetFetchMode(ADODB_FETCH_ASSOC); session_start();
$errorFormulario = 0;
...
if($errorFormulario==0){
	...
	$_SESSION['documento_destino']=$_GET['documento_destino'];$secRadicaFormularioWeb="secr_tp2_".$secRadicaFormularioWeb;
...
<table width="80%" border="0" align="center" cellpadding="0"
	...
	<tr>
		<td align="center"><input type="button" name="Submit"
			...
			value="Cerrar"
			onclick="window.location='http://www.infometrika.com/wordpress/'" />
	</tr>
	<tr>
		<td align="center">&nbsp;</td>
	</tr>
