...
<?
 ...
 if($estado_sal==2){
    $accion_sal = "Marcar Documentos Como Por Enviar";
	...
	$accion_sal = "Marcar Documentos Como Por Enviar";
	//variable que indica la acci�n a ejecutar en el formulario
	$nomcarpeta= "Marcar Documentos Como por Enviar";
	$carpeta = "nada";
              ...
              <div class="widget-body no-padding">
                 <table class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <input type=submit value="<?=$accion_sal?>" name="Enviar" id="Enviar" valign="middle" class="btn btn-primary"  onclick="marcar();">
                    </td>
                  </tr>
                  </table>
                  </td>
...
?>
 ...
 <form name='formEnviar'  method=post onsubmit="myFunction()" action=<?= $pagina_sig ?>?<?= session_name() . "=" . session_id() . "&krd=$krd&fechah=$fechah&dep_sel=$dep_sel&estado_sal=$estado_sal&usua_perm_impresion=$usua_perm_impresion&estado_sal_max=$estado_sal_max" ?> 
                ...
                <tr class='<?=$formato?>'>
                  ...
                  <td align='center' class='<?=$leido ?>' width="3%">
                    ...
                    pedientesFirma = pedientesFirma + <?=$rad_salida?> + "," ;
                      ...
                      <?}
										$rad_enviado = $rad_salida."_".$dirTipo;
										?>
                    <input type=checkbox name='checkValue[<?=$rad_enviado?>]' value='<?=$rad_enviado?>'  >
                  </td>
                </tr>
<?php
				}
