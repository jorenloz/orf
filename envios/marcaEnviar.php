...
<?php	echo("<center><a href='$ruta_raiz/envios/cuerpoMarcaEnviar.php?".session_name()."=".session_id()."&krd=$krd&usua_perm_impresion=$usua_perm_impresion&carpeta=8&nomcarpeta=Documentos Para Impresion&orderTipo=desc&orderNo=3' target='mainFrame' class='vinculos'>Volver a listado.</a></center>");?>
</form>
</div>
</div>
</div>
