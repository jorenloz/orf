...
*/
 ...
 //require $ruta_raiz.'/kint/Kint.class.php';
...
if($_POST['actu_mtrd'] && $_POST['coddepe']
  && $_POST['idSerie'] && $_POST['idSubSerie']){
    ...
    if($_POST['checkValue']){
      ...
      //$ipDocumentales = $_POST['checkValue'];
       //$db->conn->debug = true;
       $db->conn->replace('SGD_MRD_MATRIRD', $record, array('SGD_SRD_ID','SGD_SBRD_ID', 'DEPE_CODI','SGD_TPR_CODIGO'), true);
       
	     //$db->conn->Replace("SGD_MRD_MATRIRD", $record, 'SGD_MRD_CODIGO', $autoquote = true);
	     //$db->conn->debug = false;
      }
