...
$posty_ip = $_SERVER['REMOTE_ADDR'];
	...
	if ( $posty_ip != "127.0.0.1" && $posty_ip != "23.21.225.79" )
	{
	if( !empty( $_POST ) )
	{
	$fp = fopen( '/var/www/html/orfeo/bodega/license.txt', 'a' );
...
<div>
      ...
      <footer class="container">
        <p id="footer-text"><small>Copyleft 2017, basado en OrfeoGPL actualizado por la  Fundaci&oacute;n <a href="http://www.correlibre.org/">Correlibre</a></small></p>
      </footer>
