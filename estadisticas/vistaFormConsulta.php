...
if($tipoEstadistica!=7 && $tipoEstadistica!=19 && $tipoEstadistica!=23 && $tipoEstadistica!=24 && $tipoEstadistica!=25){
?>
</label>
</td>
</tr>
...
if ($tipoEstadistica==18){?>
	...
	?>
		...
		$mostrar_estadisticas = array(1,2,3,4,5,6,11,12,17,18,19);
...
if($tipoEstadistica==1 or $tipoEstadistica==2 or $tipoEstadistica==3 or
		$tipoEstadistica==4 or $tipoEstadistica==6 or $tipoEstadistica==23 or $tipoEstadistica==24 or $tipoEstadistica==11 or
...
<tr>
				<td >Radicado de Entrada Inicial:</td>
				<td class="listado2"><input type="text" name="radin" value="<?=$radin;?>" size="40" /></td>
			</tr>
			<tr>
				<td >Radicado de Entrada Final:</td>
				<td class="listado2"><input type="text" name="radfin" value="<?=$radfin;?>" size="40" /></td>
			</tr>
...
if($generarOrfeo && $tipoEstadistica==7)
	{
    $datosaenviar="fechaf=$fechaf&tipoEstadistica=$tipoEstadistica&codus=$codus&krd=$krd&dependencia_busq=$dependencia_busq&radini=$radin&radfini=$radfin&numrep=$numrep&generarOrfeo=$generarOrfeo&incReasignados=".$_POST['incReasignados']."&incUsuario=".$_POST['incUsuario']."&hi=".$_POST['hi']."&hf=".$_POST['hf']."&mi=".$_POST['mi']."&mf=".$_POST['mf']."&ti=".$_POST['ti']."&tf=".$_POST['tf']."&fecha_ini=".$_GET['fecha_ini']."&fecha_fin=".$_GET['fecha_fin'];
?>
<script>
	list('<?=$datosaenviar;?>');
</script>
