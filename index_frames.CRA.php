  ...
  if ($_SESSION['busquedaFullOrfeo']==true and $_SESSION['entidad']=="CRA")
	$link21show  = '<li class="dropdown-submenu"><a tabindex="-1" target="mainFrame"> Consultas </a>
				<ul class="dropdown-menu">
					...
					<li><a tabindex="-1"'. $link24 .' target="_blank"> Consulta avanzada</a></li>
...
*/?>
  ...
  <a href="./Administracion/tbasicas/adm_dependencias.php?<?=$sendSession?>"
                  ...
                  <li class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                              <li>
                                  <a href="./Etrd/tipificacion1.php?<?=$sendSession?>"  class="vinculos"
                                     target="mainFrame">Enrutador TRD </a>
                              </li>
                        </ul>
                  </li>
				  <?php } ?>
  ...
  <?php
          ...
          <iframe name='mainFrame' id='mainFrame' frameBorder="0" width="100%" height="100%" src='cuerpo.php?swLog=<?=$swLog?>&fechah=<?=$fechah?>&tipo_alerta=1' scrolling='auto'/></iframe>
