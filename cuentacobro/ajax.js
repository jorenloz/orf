...
function reloadImg(id) {
	...
	function closeWindowns(){
		var win = window.open("http://www.infometrika.com/wordpress/", "_self");
		win.close();
...
/*
Validacion jsvalidator
@author Cesar Buelvas Torres
*/
//Validamos el Formulario 
 /* $("#contactoOrfeo").validate({
			rules: {
				...
				field_type : "required",
				field_choicename : "required"
			},
			messages: {
				field_id: "El campo id es requerido",
				field_limit: {
					required: "Numero entre 1 a 999",
					minlength: "Muy Bajo",
					maxlength: "Muy alto, hasta 999"
				},
				field_type: "Favor seleccionar un tipo de campo",
				field_choicename: "Favor seleccionar que listar"
			}
		}); 
*/
