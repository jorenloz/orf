...
//-------------------------------
 ...
 /**
  ...
  if (strlen($flds_desde_dia) && strlen($flds_hasta_dia) &&
    ...
    if(Date('m')==1) $flds_desde_ano = Date('Y')-1; else $flds_desde_ano = Date('Y');
...
SGD_EXP_SUBEXPEDIENTE=".$_GET["s_SGD_EXP_SUBEXPEDIENTE"]."&";
  ...
  else
  {
    ...
    switch ($iSort){
        ...
        case   23: $sOrder = " order by dir.RADI_DATO_001" . $sDirection; break;
        case   24: $sOrder = " order by dir.RADI_DATO_002" . $sDirection; break;
    }
...
<!--            <td class="titulos5"><a class="vinculos" href="<?=$sFileName?>?<?=$form_params?>FormCIUDADANO_Sorting=23&FormCIUDADANO_Sorted=<?=$form_sorting?>&">Dignatario</a></td> -->
                ...
                <td class="titulos5"><a class="vinculos" href="<?=$sFileName?>?<?=$form_params?>FormCIUDADANO_Sorting=22&FormCIUDADANO_Sorted=<?=$form_sorting?>&">Apoderado</a></td>
                <td class="titulos5"><a class="vinculos" href="<?=$sFileName?>?<?=$form_params?>FormCIUDADANO_Sorting=23&FormCIUDADANO_Sorted=<?=$form_sorting?>&">Demandante</a></td>
              </tr>
...
*/
		$sSQL .= "
		dir.RADI_NUME_RADI=r.RADI_NUME_RADI AND r.TDOC_CODI=td.SGD_TPR_CODIGO";
