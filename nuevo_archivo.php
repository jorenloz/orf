...
if(!$radicado_rem){
  $radicado_rem = 1;
    ...
    $tablaHtmlDestinatarios = "<table border=0>";  
    if(!$radicado_rem) $radicado_rem=1;
    while(!$rsDestinatarios->EOF){
      ...
      $tablaHtmlDestinatarios .= "  <td  valign='top' colspan='2'  ><small> ";
      ...
      $tablaHtmlDestinatarios .= $direccionRem[$sgdDirTipoRad];
      $tablaHtmlDestinatarios .= " - ".$dpto_nombre_us[$sgdDirTipoRad] . " / " . $muni_nombre_us[$sgdDirTipoRad];
