...
if($uidDir){
  ...
  $retHtml = "Nombre    : ". $datosTercero["nombre"] . " ". $datosTercero["APELLIDO1"]. " ". $datosTercero["APELLIDO2"] ;
  $retHtml .= "Direccion : ". $datosTercero["DIRECCION"];
  $retHtml .= "Telefono  : ". $datosTercero["TELEFONO"];
  $retHtml .= "Mail      : ". $datosTercero["email"];
