...
if($genDetalle==1){
	$titulos=array("#","1#RADICADO","2#FECHA RADICADO","3#TIPO DOCUMENTO","4#ASUNTO","5#USUARIO","6#REMITENTE","7#DEPENDENCIA_INICIAL","8#DEPENDENCIA_ACTUAL","9#USUARIO ACTUAL","10#NUM FOLIOS","11#GUIA");
}
else 		
...
function pintarEstadisticaDetalle($fila,$indice,$numColumna)
{
	...
	case 10:
		...
		break;
	case 11:
		$salida="<center class=\"leidos\">".$fila['RADI_NUME_GUIA']."</center>";			
		break;
	}
	return $salida;
}
