...
$queryE = "
      ...
      */
	  ...
	  , r.radi_cuentai as REF 
          ...
          , t.SGD_TPR_TERMINO
          , t.SGD_TPR_DESCRIP
          , r.RADI_USU_ANTE USUA_ANTE
          , U2.USUA_LOGIN USUA_ACTU
	  ...
	  , an.ANEX_CREADOR
        FROM sgd_dir_drecciones d1 , USUARIO U2 ,MUNICIPIO m1, USUARIO b, HIST_EVENTOS h, SGD_TPR_TPDCUMENTO t
	  ...
	  AND r.radi_depe_actu=u2.depe_codi and r.radi_usua_actu=u2.usua_codi
...
if(isset($_GET['genDetalle'])&& $_GET['denDetalle']=1)
  $titulos=array("#","1#RADICADO","2#USUARIO","3#ASUNTO","4#REF","5#FECHA RADICACION","6#FECHA DIGITALIZACION","7#RADICADO_SALIDA","8#FECHA_ANEX_SALIDA","9#FECHA ENVIO","10#TIPO DOCUMENTO","11#TERMINO","12#DIAS DE RESPUESTA","13#DIAS A ENVIO","14#DIAS DESDE RADICACION","15#DATO_1","16#MUNICIPIO_1","17#DATO_2","18#ANEX_CREADOR","19#USUA_ACTU","20#USUA_ANTE",);
else    
      ...
      switch ($numColumna){
		...
		if($valImg == "SI")
          ...
          case 18:
            ...
            break;
          case 19:
            $salida="<center class=\"leidos\">".$fila['USUA_ACTU']."</center>";    
            break;
          case 20:
            $salida="<center class=\"leidos\">".$fila['USUA_ANTE']."</center>";    
            break;					
      }
      return $salida;
    }
