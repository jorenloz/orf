...
$where_isql1 = " WHERE DE.DEPE_CODI=R.RADI_DEPE_ACTU AND D.RADI_NUME_RADI=R.RADI_NUME_RADI and R.COD_PLANILLA IS NULL AND R.sgd_trad_codigo =2 ";
...
if(isset($_SESSION['pla']))$where_isql1.=" and R.COD_PLANILLA IS NULL and radi_usua_radi in
(
