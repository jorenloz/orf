...
class Expediente {
    ...
    function consultaExp($radicado) {
        ...
        $query = "select a.ANEX_RADI_NUME,a.ANEX_DESC, a.radi_nume_salida, a.anex_numero, t.SGD_TPR_DESCRIP
					 ,a.ANEX_NOMB_ARCHIVO, a.ANEX_BORRADO
...
#echo "<pre>$query</pre>"; exit;
            ...
            $query = "insert into SGD_SEXP_SECEXPEDIENTES(SGD_EXP_NUMERO   ,SGD_SEXP_FECH      ,DEPE_CODI   ,USUA_DOC   ,SGD_FEXP_CODIGO,SGD_SRD_CODIGO,SGD_SBRD_CODIGO,SGD_SEXP_SECUENCIA, SGD_SEXP_ANO, USUA_DOC_RESPONSABLE, SGD_PEXP_CODIGO, SGD_SRD_ID, SGD_SBRD_ID";
            if ($campoParametro != "") {
                $query .= ", $campoParametro";
            }
            $query .= " )";
            $query .= " VALUES ('$numExpediente'," . $sqlFechaHoy . " ,'$depe_codi','$usua_doc',0              ,$codiSRD     ,$codiSBRD        ,'$secExp' ,$anoExp, $usuaDocExp, $codiPROC, $this->idSerie, $this->idSubSerie";
            if ($valorParametro != "") {
