...
if ($generar_informe or $aceptarAnular) {
    ...
    $where_isql = " WHERE $whereDependencia	b.sgd_anu_sol_fecH BETWEEN " .
        ...
        " and SGD_EANU_CODI = 1 $whereTipoRadi and r.radi_nume_radi=b.radi_nume_radi and b.depe_codi = c.depe_codi and b.depe_codi != 900";
    ...
    $queryk = "Select max (usua_anu_acta)
        ...
        where sgd_eanu_codi=2 and sgd_trad_codigo = $tipoRadicado and SUBSTR(SGD_ANU_SOL_FECH,1,4) = $anio";
...
if ($aceptarAnular and $actaNo) {
	...
	$b = new CLASS_GEN();
        ...
        $html = <<<EOD
              ...
              <br>
              <br><b>SUBDIRECCIÓN ADMINISTRATIVA Y FINANCIERA</b>
	      <br>
	      <br><span >En cumplimiento a lo establecido en el Acuerdo No.060 del 30 de octubre de 2001 expedido por el Archivo General de la Nación, en el cual se establecen pautas para la administración de las comunicaciones oficiales en las entidades públicas y privadas que cumplen funciones públicas, y con base especialmente en el parpágrafo del Articulo Quinto, el cual establece que: Cuando existan errores en la radicación y se anulen los números, se debe dejar constancia por escrito, con la respectiva justificación y firma del Jefe de la unidad de correspondencia. </span> <br><p>Desde la oficina de la Subdirección Administrativa y Financiera se procede a anular los siguientes números de radicación de $TituloActam que no fueron tramitados por las dependencias radicadoras:</span>
              <br>
...
EOD;
	...
	$preName=(file_exists("../img/$entidad.banerPDF.jpg"))?$entidad.".":"";
        $html = '<img src="../img/'.$preName.'banerPDF.jpg" width="220">' . $html;
        $ruta_raiz = "..";
