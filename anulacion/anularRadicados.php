...
<br>
<br>
Por  lo  descrito,  el  Director(a)  Apoyo  Corporativo  procede a  anular los  siguientes números  de<br>
...
Director(a)  Apoyo Corporativo<br>
$entidad_largo
EOD;

	
	$preName=(file_exists("../img/$entidad.banerPDF.jpg"))?$entidad.".":"";
        $html = '                                                        <img src="../img/'.$preName.'banerPDF.jpg" width="180" height="100" >' . $html;
        $ruta_raiz = "..";
