...
$( document ).ready(function(){
  ...
  if ($("#dt_basic input:checked").length==1 && (depe==420 || depe==410 || depe==900) && entidad=='CRA'){
    $('#dialog-message').dialog('open');
        ...
        var observaBorrarInf = prompt("Por favor Introduzca el motivo para borrar el/los Infomrmados seleccionados ", "");
        if(observaBorrarInf){
        ...
        alert("Debe escribir un motivo de liminacion del Documento Informado....!");
     }
  }
    }
...
/*
  ...
  if($_SESSION["codusuario"]==1 or $_SESSION["usuario_reasignacion"] ==1){
          $whereReasignar = "where depe_estado = 1";
        }else{
          $whereReasignar = " where depe_codi = $dependencia and depe_estado = 1";
        }
