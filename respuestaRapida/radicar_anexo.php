...
//echo "<br>".$desti ."Destinatarioooooooooo";
...
//var_dump($rssPatth);
 $i=0;
  while(!$rssPatth->EOF){
    ...
    if($ciu_codigo[$i]) $ciu_codigo[$i]  = $rssPatth->fields["SGD_CIU_CODIGO"]; else $ciu_codigo[$i]="NULL";
    if($rssPatth->fields["SGD_OEM_CODIGO"]) $oem_codigo[$i]  = $rssPatth->fields["SGD_OEM_CODIGO"]; else $oem_codigo[$i]= "NULL";
...
//echo "Ciu_codigooooo".$ciu_codigo ;
...
// CREACION DEL RADICADO RESPUESTA
  ...
  //echo "$rad_salida -- $fecha_rad_salida <br />";
  ...
  if($rad_salida) $asu = str_replace('RAD_S', $rad_salida, $asu);
...
// REMPLAZAR DATOS EN EL ASUNTO
  ...
  class MYPDF extends TCPDF {
    ...
    public function Header() {
      // Logo
      $this->Image($_SESSION["headerRtaPdf"],
                    25,
		    3,
		    167,
                    0,
      ...
      $this->Image($_SESSION["footerRtaPdf"],
                    25,
                    250,
                    167,
                    '',
