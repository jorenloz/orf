...
*/
  ...
  if($ent == 2){
	...
	if($nurad){$condicion_depe = " and d.depe_codi ='$coddepe'"; }
    ...
    <div class="row">
      ...
      <div class="col-lg-6 smart-form">
        ...
        <div id="showModificar" class="col-lg-3 <?=$modificar?>">
          ...
          <label id="tipificar">
            <a  href="javascript:void(0);" onClick="window.open ('../radicacion/tipificar_documento.php?nurad=<?=$nurad?>&ind_ProcAnex=N&codusua=<?=$codusua?>&coddepe=<?=$coddepe?>&codusuario=<?=$codusua?>&dependencia=<?=$coddepe?>&tsub=0&codserie=0','busqRadicados=<?=$nurad?>','menubar=0,resizable=0,scrollbars=0,width=650,height=480,toolbar=0,location=0');" class="btn btn-link">Tipificar</a>
          </label>
		...
		<section  class="col col-2">
			<label class="select">
				<select id="tipo_usuario" class="form-control input-sm">
					<option value='0' <?php echo $ciudadano_select?> >Ciudadano / Empresas </option>
...
<br><br><br>
		...
		<section>
				...
				<label class="textarea">
						<label class="textarea">
								<select name="coddepe" multiple="multiple" id="informarUsuario">
          ...
          <section class="well smart-form col col-12">
            <div class="row">
              ...
              <section class="col col-6">
                ...
                <label class="input">
                  <input name="nofolios" id="nofolios" type="text" size="10" onkeypress="return justNumbers(event);" maxlength="5" value="<?=$numFolio?>">
                </label>
              </section>
              <section class="col col-6">
                <label class="label">
              ...
              <section class="col col-6">
                ...
                <label class="input">
                  <input name="radi_dato_001" id="radi_dato_001" type="text" maxlength="200"  value="<?=$radi_dato_001?>">
                </label>
              </section>
              <section class="col col-6">
                <label class="label">
                ...
                <label class="input">
                  <input name="ane" id="ane" type="text" maxlength="200" value="<?=$ane?>">
                </label>
              </section>
              <section class="col col-6">
                <label class="label">
                ...
                <label class="input">
                  <input name="radi_dato_002" id="radi_dato_002" type="text" maxlength="200"   value="<?=$radi_dato_002?>">
                </label>
              </section>
              ...
              <section class="col col-6">
                ...
                <input type="radio" name="nivelSeguridad" id="publico" value="0" checked> Público.
                <input type="radio" name="nivelSeguridad" id="confidencial" value="1"> Confidencial.
              </section>
            </div>
          </section>
        <br />
...
<a id="skeleton10" href="javascript:void(0);" onClick="window.open ('../radicacion/tipificar_documento.php?nurad=xxxxxx&ind_ProcAnex=N&codusua=<?=$codusua?>&coddepe=<?=$coddepe?>&codusuario=<?=$codusua?>&dependencia=<?=$coddepe?>&tsub=0&codserie=0','busqRadicados=<?=$nurad?>','menubar=0,resizable=0,scrollbars=0,width=650,height=480,toolbar=0,location=0');" class="btn btn-link hide">Tipificar</a>
