...
/*  Infometrika            info@infometrika.com    2016-05  Se modifica para usar los ids de series y subseries en vez de codigos */
/*************************************************************************************/
...
<input type='hidden' name='ar'        		value='<?=$ar?>'> 
 ...
 $querySerie .= " order by name asc";
   ...
   <tr>
	...
	include "$ruta_raiz/include/tx/ComentarioTx.php";
	print $rsSub->GetMenu2("idSubSerie", $idSubSerie, "0:-- Seleccione --", false,"","onChange='submit()' class='select'" );
...
<table width="70%" class="table table-bordered">
	...
	if ($ind_ProcAnex=="S")
		{
			echo " <br> <input type='button' value='Cerrar' id='CerrarTAnexos' class='btn btn-default btn-xs'> ";
		}	
	?>
	</td>
		</tr>
