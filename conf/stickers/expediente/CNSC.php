    ...
    <table width="400px" cellpadding="0" cellspacing="0" onload="window.print()">
        <tr>
	    	...
	    	<table width="100%">
				...
				<td width="20%"><img src="<?=$dirLogo?>" alt="<?=$entidad_corto?>"  height="122" width="202"></td>
			</tr>
			<tr>
				<td width="80%"><center><span style="font-size: 28;letter-spacing: 0pt ;font-family: 'Free 3 of 9'" ><?=$noExpBarras?><span></center></td></tr>
				<tr>
		</table>
		...
		<!--Falta incluir el destinatario--><br><br>
