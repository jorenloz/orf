    ...
    <table width="400px" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td  align=left width="300px"> 
                ...
                <span><center><img src="barcode_img.php?num=<?php echo($numrad) ?>&type=Code39&imgtype=png" width=250><center><span>
                <p><span><b>Destino: <?=$radi_depe_actu?> <?=substr($dependenciaDestino,0)?>
                 - Rem: <?=substr($remite,0,18); ?> </b></span></p>
                <p><span  align="left"><b>
                    Folios: <?=$radi_nume_folio?> &nbsp;&nbsp; Anexos:<?=$radi_desc_anex?> <?=$radi_nume_anexo?> &nbsp;&nbsp; Copias: <?=$copias?>   </b>
                </span></p>

                <span  align="left"><b>
                    <?=substr($radi_fech_radi,0,16). " "?>  &nbsp;&nbsp; C&oacute;d veri: <?=$sgd_rad_codigoverificacion?> </b>
                </span>
                <!-- <p><span><b>Consulte su tr&aacute;mite en http://www.onac.org.co</b></span></p>-->
            </td>                     
        </tr>
<!--
        <tr>
