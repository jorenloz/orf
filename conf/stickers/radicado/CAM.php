...
<?php 
$dirLogo = "../../img/CAM.logoEntidad.png";
?>
...
<!--             <p><span><b> <?=$noRadBarras?> </b></span></p> -->
	...
	<tr>
	    <td  width="20%" style="padding-right:10px;padding-top:3px" >
		<img src="<?=$dirLogo?>" alt="<?=$entidad_corto?>"  height="30" width="120">
                <p><span><b> Carrera 1 No.60 79 Neiva - Huila </b></span></p>
<!--                <p><span><b> Neiva - Huila </b></span></p> -->
                <p><span><b> PBX (578) 8765017 - FAX 8765344 </b></span></p>
                <p><span><b> camhuila@cam.gov.co </b></span></p>
