...
//cho "<hr> $valRadio <hr>";
	...
	$depe_dir += 0;	
	$uploadDir = $CONTENT_PATH.substr($valRadio,0,4)."/".$depe_dir."/";
	$ext =  array_pop(explode(".",$tmpFile));
	$fileGrb = substr($valRadio,0,4)."/".$depe_dir."/$valRadio".".".$ext;
  ...
  $my_upload->the_file = $_FILES['upload']['name'];
	...
	//Coreccion "chambona" para anexos
	$newFile = "1".$newFile;
  }else{
